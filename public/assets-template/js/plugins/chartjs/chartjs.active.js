        ...
        var RSCconfig = {
            ...
            data: {
                ...
                },
                {
                    ...
                    backgroundColor: '#FF5194',
                    borderColor: '#FF5194',
                    borderWidth: 3,
                    pointBackgroundColor: '#ffffff',
                    pointBorderColor: '#FF5194',
                    pointBorderWidth: 3,
                    pointRadius: 6,
                    pointHoverBackgroundColor: '#ffffff',
                    pointHoverBorderWidth: 3,
    ...
    if( $('#chartjs-graph-chart').length ) {
        ...
        var GRAPHconfig = {
            ...
            data: {
                ...
                datasets: [{
                    data: [20, 23, 30, 27],
                    backgroundColor: ["#FF5194", "#fb7da4", "#ff9666", "#17a2b8"],
                    hoverBackgroundColor: ["#FF5194", "#fb7da4", "#ff9666", "#17a2b8"],
    ...
    if( $('#example-chartjs-polar').length ) {
        ...
        var ECPolarconfig = {
            ...
            data: {
                ...
                datasets: [{
					data: ['80', '55', '45', '20', '30'],
					backgroundColor: ['#FF5194', '#fb7da4', '#29db2d', '#ff9666', '#17a2b8'],
				}],
            },
            options: {
                maintainAspectRatio: false,
